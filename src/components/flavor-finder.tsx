...
const moods = [
  {
    ...
    title: "Nachos Chili Beans",
    copy: "Tortilla de milho crocante, sem conversantes, tudo fresco e natural. Vale cada mordida!",
  ...
  },
  {
    ...
    title: "Churros Palito",
    copy: "Produzido por nós, crocante por fora e macio por dentro.",
