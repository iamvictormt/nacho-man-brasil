...
export default function Home() {
  return (
    <main className="min-h-screen overflow-x-clip bg-background text-foreground">
      ...
      <section
        className="relative isolate flex min-h-[650px] items-center overflow-hidden bg-foreground text-background md:min-h-[900px]"
        aria-label="Bem-vindo à Nacho Man"
      >
        <HeroVideo />
        <div
          className="absolute inset-0 bg-[linear-gradient(90deg,oklch(0.12_0_0/0.9),oklch(0.12_0_0/0.52)_58%,oklch(0.12_0_0/0.15)),linear-gradient(0deg,oklch(0.12_0_0/0.68),transparent_52%)]"
          aria-hidden="true"
        />
        <EditorialHeroContent
          title="Comida mexicana"
          accent="Sem frescura."
          copy="Franquia de comida mexicana autêntica no Brasil."
          note="Desde 2018 · Comida de verdade"
        >
