...
export function SiteHeader() {
  ...
  const handleNavigationClick = (event: MouseEvent<HTMLAnchorElement>, href: string) => {
    ...
    if (targetHash || pathname !== targetPath) return;
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-[70] border-b border-background/15 bg-foreground/95 py-4 xl:py-6 text-background backdrop-blur-md">
        <div className="site-container grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4 xl:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] xl:gap-6">
          <Link
            href="/"
          ...
          <nav
            className="hidden items-center gap-6 whitespace-nowrap xl:flex xl:justify-self-center"
          ...
          <div className="hidden items-center justify-self-end gap-2 whitespace-nowrap xl:flex">
            <Link
              href="/encontrar-loja"
              onClick={(event) => handleNavigationClick(event, "/encontrar-loja")}
            ...
            <div className="grid flex-1 gap-8 md:grid-cols-[1.35fr_0.65fr] md:items-start md:gap-10">
              ...
              <div className="mobile-menu-item grid content-start gap-3 md:pt-1">
                ...
                <Link
                  ...
                  className="group flex min-h-14 items-center justify-between rounded-2xl bg-background px-5 text-[0.65rem] font-extrabold uppercase text-foreground transition hover:-translate-y-1"
                >
